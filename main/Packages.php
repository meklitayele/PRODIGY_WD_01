  ...
  <body>
    ...
    <div class="Wrapper">
      ...
      <div class="container">
        ...
        <div class="box">
          <img src="./Packages/photo/jimma.jpg" alt="unitypark" />
          <h3>Trip to Jimma</h3>
          <p>
          ...
          <a href="./jimma.php" class="btn" target="_blank"
            >BOOK</a
          >
        </div>
        <div class="box">
          <img src="./Packages/photo/afar.jpg" alt="Fendika Cultural Center" />
          <h3>Trip to Afar </h3>
          <p>
          ...
          <a href="./afar.php" class="btn" target="_blank"
            >BOOK</a
          >
