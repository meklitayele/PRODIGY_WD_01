...
<head>
  ...
  <link href="https://api.fontshare.com/v2/css?f[]=gambetta@400,1,300,600,701,2,501,401,301,601,500,700&display=swap"
    rel="stylesheet">
  <link href="https://api.fontshare.com/v2/css?f[]=satoshi@1,900,700,500,301,701,300,501,401,901,400,2&display=swap"
    rel="stylesheet">
    ...
    <nav class="navBar">
      <div class="navDiv">
        <ul>
          ...
          <li><a href="placestovisit.html" target="_blank">PLACES TO VISIT</a></li>
    ...
    <div class="contactInfo">
      ...
      <div class="contactInfoName">
        ...
        <div class="labels">
          ...
          <div><label for="consent">I have agreed to the <a href="">Privacy Policy</a></label></div>
        </div>
